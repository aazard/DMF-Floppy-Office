...
### Dedicated to my father and my son. _May I see you both again_.
...
### What Can You Do? Toolkit includes 22 Tools:
...
- Securly delete files.

- Send and recieve emails, with alerts and attachments supported.
...
- Calender that supports notes and schedules. 

***

### If you need to, please google "_How to format a floppy to 1.68mb DMF?_".

### USB versions of this toolkit are avaible on my github and websites.

***

### Dated: December the 28 of 2020.
...
2. Running desire app, from folder on target PC/Media, and any additional required files will be created.
...
- Created using FoldersReport (http://www.nirsoft.net/).
